      ...
      if dirname == []:
        ...
        if count %2 == 1:
          ...
          for i in range(len(pitchImages)):
            ...
            fileName = '/opt/src/prediction/labels.tif'
            ...
            print('波段数::', dataset.RasterCount, width, height)
            #  获取数据
            if(data_width == 0 and data_height == 0):
                data_width = width
                data_height = height
            data = dataset.ReadAsArray(0, 0, data_width, data_height)
            data = convertjpg(data)
